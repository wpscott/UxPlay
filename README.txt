...
-   For best performance, the Raspberry Pi needs the GStreamer
    ...
    tree](https://github.com/raspberrypi/linux), but Distributions for R
    Pi that supply it include Raspberry Pi OS, Ubuntu, and Manjaro (all
    available from Raspberry Pi with their Raspberry Pi Imager). Other
    distributions generally do not provide it: **without this kernel
    module, UxPlay cannot use the decoding firmware in the GPU.**
