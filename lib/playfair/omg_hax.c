...
unsigned char sap_iv[] = {
	0x2B, 0x84, 0xFB, 0x79, 0xDA, 0x75, 0xB9, 0x04, 0x6C, 0x24, 0x73, 0xF7, 0xD1, 0xC4, 0xAB, 0x0E, 0x2B, 0x84, 0xFB,
	0x79, 0x75, 0xB9, 0x04, 0x6C, 0x24, 0x73
};

unsigned char sap_key_material[] = {
	0xA1, 0x1A, 0x4A, 0x83,
	0xF2, 0x7A, 0x75, 0xEE,
	0xA2, 0x1A, 0x7D, 0xB8,
	0x8D, 0x77, 0x92, 0xAB
...
void permute_block_1(unsigned char* block)
{
	...
	print_block("Permutation complete. Final value of block: ", block);
...
void permute_block_2(unsigned char* block, int round)
{
	...
	print_block("Permutation (2) complete. Final value of block: ", block);
	// This looks right to me, at least for decrypt_kernel
}
...
unsigned char initial_session_key[] = {
